    ...
    <>
      <div className="LastContainer w-11/12 m-auto gap-x-16 max-md:gap-x-8 max-sm:gap-2 grid grid-cols-2 text-white mt-50">
        <div className="head flex flex-col gap-2 w-full">
          <div className="text-5xl max-lg:text-3xl max-md:text-2xl max-sm:text-2xl font-bold">
            Let's talk business
          </div>
          <div className="text-gray-500 max-md:text-xs max-lg:text-sm">
            {" "}
        ...
        <div className="InputContainer w-full ">
          ...
          >
            <label
              ...
              className="font-bold  max-md:text-sm max-sm:text-xs"
            >
              Name
            </label>
            <input
            ...
            <label
              ...
              className="font-bold mt-5 max-sm:mt-2 max-md:text-sm max-sm:text-xs"
            >
              Email
            </label>
            <input
